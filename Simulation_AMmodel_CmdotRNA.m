...
load('D:\ChSun\Cmdot_RNA_Xband\RNA1_12_new.mat')
% load('D:\ChSun\Masterarbeit\AMmodel_RNA\RNA1_12dot.mat')
...
sigma_y=6;
[Simulated,R_mean,ymax] = AM_PELDOR_CmdotRNA(sigma_y,12,EP,zeit,model)
% [Simulated,R_mean] = AM_PELDOR_CmdotRNA(sigma_y,12,EP,zeit,model)
% [Simulated,R_mean,ymax] = AM_C_PELDOR_CmdotRNA(sigma_y,12,EP,zeit);
...
%%CmRNA
Exp=importdata('SumX_CmdotRNA1_12_distr.dat');
% Exp=importdata('Cmdot_sdRNA_4PPeldor_distr.dat');
...
str2=num2str(sigma_y);
title(['Çm RNA1-12 (',str2,'^o)']);
set(gca,'linewidth',1.5) 

% CmRNAModelA
% savefig(F,['Z:\Students\ChSun\Masterarbeit\11.07_Result\CmARNA_z_ratio=1.12\CmRNA_ModelA_Gband\Gband_CmdotARNA_ModelA1_12.fig'])
% savePDF('Z:\Students\ChSun\Masterarbeit\11.07_Result\CmARNA_z_ratio=1.12\CmRNA_ModelA_Gband\',['Gband_CmdotARNA_ModelA1_12.pdf'])
